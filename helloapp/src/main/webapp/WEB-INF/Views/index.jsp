...
<nav class="w3-sidenav w3-center w3-small w3-hide-small">
  ...
  <img src="resources/images/avatar_smoke.jpg" style="width:100%">
...
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
    ...
    <img src="resources/images/man_smoke.jpg" alt="boy" class="w3-image" width="992" height="1108">
  </header>
  ...
  <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about">
    ...
    <img src="resources/images/bandmember.jpg" alt="Avatar" class="w3-left w3-circle w3-margin-right" style="width:80px">
    <p><span class="w3-large w3-margin-right">Chris Fox.</span> CEO at Mighty Schools.</p>
    <p>Jane Doe saved us from a web disaster.</p><br>
    
    <img src="resources/images/avatar_g2.jpg" alt="Avatar" class="w3-left w3-circle w3-margin-right" style="width:80px">
  ...
  <div class="w3-padding-64 w3-content" id="photos">
    ...
    <div class="w3-row-padding" style="margin:0 -16px">
      <div class="w3-half">
        <img src="resources/images/wedding.jpg" style="width:100%">
        <img src="resources/images/rocks.jpg" style="width:100%">
        <img src="resources/images/sailboat.jpg" style="width:100%">
      </div>

      <div class="w3-half">
        <img src="resources/images/underwater.jpg" style="width:100%">
        <img src="resources/images/chef.jpg" style="width:100%">
        <img src="resources/images/wedding.jpg" style="width:100%">
        <img src="resources/images/p6.jpg" style="width:100%">
      </div>
    <!-- End photo grid -->
    </div>
  ...
  <footer class="w3-content w3-padding-64 w3-text-grey w3-xlarge">
    ...
    <p class="w3-medium">Powered by <a href="http://www.google.com" target="_blank" class="w3-hover-text-green">Google</a></p>
  <!-- End footer -->
  </footer>
